...
(function () {
  ...
  function initCarousel(wrapper) {
    ...
    wrapper.setAttribute('aria-label', 'Medien-Karussell');
    ...
    imgs.forEach(function (img, i) {
      ...
      slide.setAttribute('aria-label', 'Folie ' + (i + 1) + ' von ' + imgs.length);
    ...
    /* ── Arrows ─────────────────────────────────────────────── */
    var prevBtn = makeArrow('prev', '&#8249;', 'Vorherige Folie');
    var nextBtn = makeArrow('next', '&#8250;', 'Nächste Folie');
    ...
    slides.forEach(function (_, i) {
      ...
      btn.setAttribute('aria-label', 'Zu Folie ' + (i + 1) + ' springen');
